...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_LOWER] = LAYOUT(
        _______, PSTE,       UNDO,    COPY,    _______,  _______, _______, _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,
        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,     _______, _______, _______, KC_6,    KC_7,    KC_8,    KC_9,     KC_0,
        _______, _______, V_Q,     V_W,     V_WQ,     _______, _______, _______, V_CJ,    V_SV,    _______, _______,  _______,
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, _______, _______, LPRN,    MY_LBRC,  _______, _______, _______, MY_RBRC, RPRN,    N_LEFT,  N_RGHT,  _______,
     ...
     */
    [_ADJUST] = LAYOUT(
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, _______, _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,
        _______, _______, MS_BTN2, MS_BTN1, _______, _______, _______, _______, MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT,  _______,
        KC_F11,  KC_F12,  KC_F13,  KC_F14,  SLP,     _______, _______, _______, _______, WH_D,    WH_U,    _______,  _______,
     ...
     */
    [_NAGINATA] = LAYOUT(
        NG_Q,    NG_W,    NG_E,    NG_R,    NG_T,    _______, _______, _______,  NG_Y,     NG_U,    NG_I,    NG_O,    NG_P,
        NG_A,    NG_S,    NG_D,    NG_F,    NG_G,    _______, _______, _______,  NG_H,     NG_J,    NG_K,    NG_L,    NG_SCLN,
        NG_Z,    NG_X,    NG_C,    NG_V,    NG_B,    _______, _______, _______,  NG_N,     NG_M,    NG_COMM, NG_DOT,  NG_SLSH,
